        ...
        <div class="max-w-screen-md m-auto absolute inset-0">
            <form id="login" class="w-10/12 border rounded-2xl m-auto flex flex-col justify-center items-center my-8 shadow-lg min-h-[665px] bg-white">
                ...
                <div class="flex flex-col justify-center items-center m-2 w-full">
                    ...
                    <input v-model="user.email" id="email" class="border border-gray shadow-sm w-10/12 max-w-xs rounded pl-1 focus:ring-2 ring-offset-2 focus:ring-red-300" required type="email" minlength="6"/>
                </div>
                <div class="flex flex-col justify-center items-center m-2 w-full">
                    <label for="password">Mot de passe</label>
                    <input v-model="user.password" id="password" class="border border-gray shadow-sm w-10/12 max-w-xs rounded pl-1 focus:ring-2 ring-offset-2 focus:ring-red-300" required type="password" minlength="8" maxlength="20"/>
                </div>
